...
import { symbolFor, fmtAmt, fmtDist } from "@/lib/formatUtils";
...
/** Compute the walking route distance for a day's pins (sequential). */
...
export default function StatsPanel() {
  ...
  const stats = useMemo(() => {
    ...
    // --- Activity/type breakdown (single pass) ---
    ...
    // --- Spending (single pass for totals + per-day + per-category) ---
    let totalSpent = 0;
